...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_LGUI_GL] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_LGUI, _GL),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_KL] = LAYOUT(
        ...
        KC_CAPS,           KC_A,           KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,     KC_ENT,
        KC_LSFT,           KC_Z,           KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                           KC_UP,
        KC_LCTRL,  TD(TD_LGUI_GL), KC_LALT,                   KC_SPC,                             KC_RALT, TT(_FL), KC_APP, KC_RCTL,                    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FL] = LAYOUT(
        _______, _______, _______, _______,  _______, _______, _______, _______,  _______,  _______, _______, KC_WAKE, KC_SLEP,          KC_MUTE, _______, _______,
        _______, _______, _______, TG(_GL),  _______, _______, _______, _______,  _______,  ROUT_FM, ROUT_TG, ROUT_VD, ROUT_VI, _______, KC_MSTP, KC_MPLY, KC_VOLU,
    ...
    [_GL] = LAYOUT(
        ...
        _______, TG(_GL), _______,                   _______,                            _______, TG(_GL), _______, _______,          _______, _______, _______
    ),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_FL] = {
        _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,   _______, YELLOW,  YELLOW,        TEAL,    _______,_______,
        _______, _______, _______,    PINK, _______, _______,    _______, _______, _______, GREEN,   GREEN,   GREEN,   GREEN,   _______, TEAL,    TEAL,   TEAL,
        ...
        _______, ORANGE,  _______, CORAL,   _______, AZURE,   AZURE,   _______, _______, _______, _______, AZURE,                              YELLOW,
        _______, _______, _______,                   _______,                            _______, PINK,    _______, AZURE,            _______, YELLOW, _______
    },
    // [_ML] = {
