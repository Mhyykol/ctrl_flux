...
#define RGBLIGHT_SAT_STEP 10        // Units to step when in/decreasing saturation
#define RGBLIGHT_VAL_STEP 6        // Units to step when in/decreasing value (brightness)
#define RGBLIGHT_SPD_STEP 5        // Units to step when in/decreasing speed
#define RGB_MATRIX_STARTUP_HUE 75 // Sets the default hue value, if none has been set
#define RGB_MATRIX_STARTUP_SAT 255 // Sets the default saturation value, if none has been set
#define RGB_MATRIX_STARTUP_SPD 112 // Sets the default animation speed, if none has been set
// ===========================================================================================================================================

// #define RGB_DISABLE_AFTER_TIMEOUT 0   // number of ticks to wait until disabling effects
// #define RGB_DISABLE_WHEN_USB_SUSPENDED false // turn off effects when suspended
// #define RGB_MATRIX_LED_PROCESS_LIMIT (DRIVER_LED_TOTAL + 4) / 5 // limits the number of LEDs to process in an animation per tadddddddsk run (increases keyboard responsiveness)
