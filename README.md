...
I saw the Endgame keymap and decided to make my own. But version controlled so here we are
...
Most of this code is from https://github.com/qmk/qmk_firmware/tree/master/keyboards/massdrop/ctrl/keymaps/endgame. I just edit the code a bit and kept the original credits.
